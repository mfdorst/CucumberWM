...
def main():
    ...
    binary_src = f'{src_dir}/target/release/cucumberwm'
    binary_dest = '/usr/bin/cucumberwm'
    start_script_src = f'{src_dir}/cucumberwm-start'
    start_script_dest = '/usr/bin/cucumberwm-start'
    desktop_src = f'{src_dir}/cucumberwm.desktop'
    desktop_dest = '/usr/share/xsessions/cucumberwm.desktop'
